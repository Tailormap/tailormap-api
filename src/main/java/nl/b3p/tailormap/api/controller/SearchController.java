...
public class SearchController {
  ...
  @Timed(value = "search", description = "time spent to process search request")
  ...
  public ResponseEntity<Serializable> search(
    ...
    try (SolrClient solrClient = getSolrClient();
      ...
      final SolrDocumentList documents =
          solrUtil.findInIndex(
              SolrUtil.getLayerId(service.getId(), layer.getName()), q, start, numResultsToReturn);
