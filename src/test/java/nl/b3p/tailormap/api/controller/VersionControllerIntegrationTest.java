...
class VersionControllerIntegrationTest {
  ...
  void readEnvironment() {
    ...
    assumeFalse(
        null == projectVersion, "Project version unknown, should be set as system property");
    ...
    buildDate =
        LocalDateTime.parse(System.getenv("BUILD_DATE"), DateTimeFormatter.ISO_OFFSET_DATE_TIME)
            .toEpochSecond(ZoneOffset.UTC);
  }

  @Test
  void testGetVersion() {
    assertNotNull(versionController, "versionController can not be `null` if Spring Boot works");
