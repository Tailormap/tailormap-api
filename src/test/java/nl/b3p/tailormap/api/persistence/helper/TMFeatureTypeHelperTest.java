...
class TMFeatureTypeHelperTest {
  ...
  void getConfiguredAttributes() {
    ...
    final Function<String,TMAttributeDescriptor> att = (name) -> new TMAttributeDescriptor().name(name).comment("comment for " + name);
    ...
    Map<String, Pair<TMAttributeDescriptor, AttributeSettings>> configuredAttributes = TMFeatureTypeHelper.getConfiguredAttributes(ft);
