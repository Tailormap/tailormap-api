...
class PrometheusDataControllerIntegrationTest {
  ...
  void get_application_graphic_data() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_graphic_data_60_days() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_graphic_data_invalid_number_of_days() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_layers_graphic_data() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_layers_graphic_data_60_days() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_layers_graphic_data_app_does_not_exist() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_layers_graphic_data_invalid_app_id() throws Exception {
  ...
  @WithMockUser(
      username = "tm-admin",
      authorities = {Group.ADMIN})
  void get_application_layers_graphic_data_invalid_number_of_days() throws Exception {
