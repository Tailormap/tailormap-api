...
class IngestMetricsControllerIntegrationTest {
  ...
  void testIngestLayerSwitchedOnMetric() throws Exception {
            ...
            content()
                .string(
                    containsStringIgnoringCase(
                        """
tailormap_applayer_switched_on_total{appId="1",appLayerId="lyr:snapshot-geoserver:postgis:begroeidterreindeel",appName="default",appType="app"} 1.0
""")));
  }
